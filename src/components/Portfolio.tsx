      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {displayProjects.map((project: any, index) => (
            ...
            >
              <div className="relative h-64 overflow-hidden bg-gradient-to-br from-blue-100 to-cyan-100 dark:from-gray-700 dark:to-gray-800">
                {project.image_url ? (
                  <img
                ...
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition shadow-lg">
                  <ExternalLink className="w-6 h-6 text-blue-600" />
                </div>
                {project.technologies && project.technologies.length > 0 && (
                  <div className="absolute bottom-4 left-4 flex flex-wrap gap-1 opacity-0 group-hover:opacity-100 transition">
